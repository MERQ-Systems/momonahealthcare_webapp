...
<script src="<?php echo base_url(); ?>backend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script><div class="content-wrapper">  
            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('opd_prescription_header_footer'); ?></h3>
                    </div>
                <div class="box-body">
                    <form role="form"  enctype="multipart/form-data" action="<?php echo site_url('admin/printing/update') ?>" class="" method="post">
