                                ...
                                <div class="box-body">     
                                    <div class="tab-content">
                                        <div class="" id="tab_parent">
                                            <div class="download_label"><?php echo $this->lang->line('payroll_month_report_for'); ?> <?php echo $month . " " . $year; ?></div>
                                                ...
                                                <tbody>
                                                    ...
                                                    if (empty($result)) {
                                                           ...
                                                           // $gross += $value["basic"] + $value["total_allowance"];
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#"><?php echo composeStaffNameByString($value['name'], $value['surname'],$value['employee_id']); ?></a></span>
                                                                ...
                                                                <td class="text text-right">
                                                                    ...
                                                                    <?php echo number_format($gross_salery, 2, '.', ''); // number_format($value['basic'] + $value['total_allowance'], 2, '.', ''); ?>
                                                                </td>
                                                                <td class="text text-right">
                                                                    <?php
                                                                    $t = ($value['tax']);
                                                                    echo number_format($tax_amount, 2, '.', '').' ('.(number_format($t, 2, '.', '')).'%)';
                                                                    ?>
                                                                </td>
                                                                <td class="text text-right">
                                                                    <?php
                                                                    $t = ($value['net_salary']);
                                                                    echo (number_format($gross_salery - $tax_amount, 2, '.', ''));
                                                                   // echo (number_format($t, 2, '.', ''))
                                                                    ?>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <tr class="box box-solid total-bg">
                                                            ...
                                                            <td class="text text-right"><?php echo $currency_symbol.number_format($total_tax_amount, 2, '.', '').' ('.number_format($tax, 2, '.', '').'%)'; ?></td>
                                                            <td class="text text-right"><?php echo ($currency_symbol . number_format($total_net, 2, '.', '')); ?></td>
