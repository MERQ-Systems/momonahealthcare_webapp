                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <form action="<?php echo base_url(); ?>patient/onlineappointment/jazzcash/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="border_bottom">
                                            ...
                                            <td class="text-right"><?php echo $setting['currency_symbol'] . amountFormat($amount); ?></td>
                                        </tr>
