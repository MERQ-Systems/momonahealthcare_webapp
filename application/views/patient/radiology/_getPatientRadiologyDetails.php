	  ...
	  <table class="table table-hover table-sm">
        <thead>
          <tr class="line">
            ...
            <td class="text-left"><strong><?php echo $this->lang->line('upload_date'); ?></strong></td>
        ...
        ?>
          <tr>
            ...
            <td class="text-center">
              ...
              <?php  echo composeStaffNameByString($report_value->approved_by_staff_name,$report_value->approved_by_staff_surname,$report_value->collection_specialist_staff_employee_id);	 ?>
              <br/>
