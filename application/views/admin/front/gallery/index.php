...
if ($this->rbac->hasPrivilege('gallery', 'can_edit')) {
        ...
        if ($this->rbac->hasPrivilege('gallery', 'can_delete')) {
            ?>
                                                            <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordByIdReload('admin/front/gallery/delete/<?php echo  $page['id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')">
