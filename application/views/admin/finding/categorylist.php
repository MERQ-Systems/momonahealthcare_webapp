                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('finding_category', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm finding_head"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_finding_category'); ?></a>
                            <?php } ?>     
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/finding/addfindingcategory') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('finding_category'); ?></label><small class="req"> *</small>
                            <input autofocus="" id="finding_category" name="finding_category" placeholder="" type="text" class="form-control"  value="<?php echo set_value('finding_type'); ?>" />
