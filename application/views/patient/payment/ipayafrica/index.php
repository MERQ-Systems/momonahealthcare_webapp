                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-offset-6 col-xs-6">
                                ...
                                <form action="<?php echo base_url(); ?>patient/payment/ipayafrica/index" method="post" >
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="<?php echo $patient_data['mobileno'] ?>" />
