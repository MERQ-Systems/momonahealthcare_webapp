...
if ($this->rbac->hasPrivilege('notice', 'can_edit')) {
        ...
        if ($this->rbac->hasPrivilege('notice', 'can_delete')) {
            ?>
                <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordByIdReload('admin/front/notice/delete/<?php echo $page['id'];?>', '<?php echo $this->lang->line('delete_message'); ?>')">
