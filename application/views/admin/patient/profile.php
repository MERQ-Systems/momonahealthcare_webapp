...
window.location.href = baseurl+'admin/patient/search';
    ...
    $(document).on('click','.add-record',function(){
        ...
        var row = "<tr id='row" + prescription_rows + "'><td>" + div + "</td><td><button type='button' onclick='delete_row("+prescription_rows+")' data-row-id='"+prescription_rows+"' class='closebtn delete_row'><i class='fa fa-remove'></i></button></td></tr>";
