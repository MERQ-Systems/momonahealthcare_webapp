...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/department/getdepartmentdatatable');
    });
} ( jQuery ) )
</script>
<!-- //========datatable end===== --> 
<script>
    ...
    {
        delete_recordById('admin/department/departmentdelete/' + id, '<?php echo $this->lang->line('delete_confirm') ?>');
    }
