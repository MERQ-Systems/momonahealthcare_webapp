...
<form action="{$same_page}" method="post">
    <table cellpadding="0" cellspacing="1" class="list_table" width="100%">
        ...
        <tr>
            <td width="170" class="nowrap pad_left pad_right_large">{$L.phrase_export_timeout}</td>
            <td class="medium_grey pad_left">
                <input type="number" name="export_timeout" value="{$module_settings.export_timeout|escape}" style="width: 50px" /> seconds
            </td>
        </tr>
        <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td><input type="text" name="file_upload_dir" id="file_upload_dir"
                                   value="{$module_settings.file_upload_dir|escape}" style="width: 98%"/></td>
                        <td width="180">
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td><input type="text" name="file_upload_url" id="file_upload_url"
                                   value="{$module_settings.file_upload_url|escape}" style="width: 98%"/></td>
                        {if $allow_url_fopen}
