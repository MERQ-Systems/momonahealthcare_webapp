            ...
            payButton.addEventListener('click', function () {
                snap.pay('<?php echo $snap_Token; ?>', {// store your snap token here
                    onSuccess: function (result) {
                        ...
                        $.ajax({
                            url: '<?php echo base_url(); ?>patient/onlineappointment/midtrans/complete',
                            type: 'POST',
                            data: $('#payment-form').serialize(),
                            dataType: "json",
                            success: function (msg) { 

                                window.location.href = "<?php echo base_url(); ?>patient/onlineappointment/checkout/successinvoice/" + msg.appointment_id;
