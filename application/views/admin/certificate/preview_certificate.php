...
<div class="" style="position: relative; text-align: center; font-family: 'arial';">   
    <?php if (!empty($certificate->background_image)) { ?>
        <img src="<?php echo base_url('uploads/certificate/' . $certificate->background_image.img_time()); ?>" style="width: 100%; height: 100vh" />
    <?php } ?>

    <table width="100%" cellspacing="0" cellpadding="0" style="position: absolute;top: 0; text-align: left; margin-left: auto; margin-right: auto;left: 0;right: 0;<?php echo "width:" . $certificate->content_width . "px" ?>">
        <tr>
            <td style="position: absolute;left:0;">
                <?php if ($certificate->enable_patient_image == 1) { ?>
                    <img style="position: relative; <?php echo "top:" . $certificate->enable_image_height . "px" ?>;" src="<?php echo base_url('uploads/patient_images/no_image.png'.img_time()) ?>" width="100" height="auto">
                <?php } ?>
            </td></tr>
        <tr>
