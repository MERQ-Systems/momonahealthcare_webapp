...
?>
                            ...
                            <div class="form-group">
                                ...
                                <label class="pr20 d-md-block"><?php echo $this->lang->line('page_type'); ?></label>
                                <?php
                ...
                <div class="col-md-3 col-sm-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools2 pull-right">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools2 pull-right">
                                <!-- Buttons, labels, and many other things can be placed here! -->
                                <!-- Here is a label for example -->
                                <button class="btn btn-box-tool delete_media" data-widget="collapse" data-toggle="tooltip" title="<?php echo $this->lang->line('collapse'); ?>"><i class="fa fa-minus"></i></button>
                            </div><!-- /.box-tools -->
                        </div><!-- /.box-header -->
