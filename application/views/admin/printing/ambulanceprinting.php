            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('ambulance_header_footer'); ?></h3>
                    </div>                  
                    <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group"><label><?php echo $this->lang->line('footer_content'); ?></label>
                                        <textarea id="compose-textarea" name="footer_content" class="form-control" style="height: 250px">
