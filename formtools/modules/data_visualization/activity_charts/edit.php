...
if (isset($_POST["update"])) {
	list($success, $message) = ActivityCharts::updateActivityChart($request["vis_id"], $request["tab"], $request, $L);
}
...
$page_map = array(
    "main" => "page_main.php",
    "appearance" => "page_appearance.php",
    "permissions" => "page_permissions.php",
    "advanced" => "page_advanced.php"
);
