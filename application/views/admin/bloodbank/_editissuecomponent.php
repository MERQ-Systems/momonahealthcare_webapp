...
<input type="hidden" name="post_component_id"  class="post_component_id" value="<?php echo $result['component_id'];?>">
                        ...
                        <div class="col-sm-3">
                           ...
                           <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select  style="width: 100%" class="form-control select2 blood_group"  name="blood_group" id="component_blood_group" >
                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div>
                                                    <?php
                                                        echo display_custom_fields('component_issue', $result["id"]);
                                                    ?>
                                                </div>
                                            </div>
                                        </div><!--./col-sm-6-->
                                        ...
                                        <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" value="<?php echo calculatePercent($result['amount'],$result['discount_percentage']); ?>" name="discount" id="discount" style="width: 50%; float: right" class="form-control discount"/></td>
                                                ...
                                                <input type="text" placeholder="<?php echo $this->lang->line('tax'); ?>" name="tax_percentage" id="tax_percentage" value="<?php echo set_value('tax_percentage',$result['tax_percentage']); ?>" class="form-control tax_percentage" readonly style="width: 70%; float: right;font-size: 12px;"/> </td>
                                                    <td class="text-right ipdbilltable">
                                                        ...
                                                        <input type="text" placeholder="<?php echo $this->lang->line('tax'); ?>" name="tax" value="<?php echo calculatePercent($total_amount,$result['tax_percentage']); //calculatePercent($result['amount'],$result['tax_percentage']); ?>" id="tax" style="width: 50%; float: right" class="form-control tax" readonly/>
