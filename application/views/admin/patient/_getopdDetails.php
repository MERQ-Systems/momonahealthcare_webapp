        ...
        <div class="table-responsive">
            <table class="table mb0 table-striped table-bordered examples tablelr0space noborder">
                <tr>
                    ...
                    <td width="35%"><span id="opd_no"><?php echo $this->customlib->getSessionPrefixByType('checkup_id') .$result["id"] ; ?></span>
                    </td>
                    <th width="15%"><?php echo $this->lang->line('opd_id'); ?></th>
                    <td width="35%"><span id="opd_no"><?php echo $this->customlib->getSessionPrefixByType('opd_no') .$result["opd_details_id"] ; ?></span>
                    </td>    
                </tr>
        	    <tr>
