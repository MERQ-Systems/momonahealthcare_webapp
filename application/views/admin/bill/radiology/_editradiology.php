                                    ...
                                    <div class="col-sm-6">
                                        <table class="printablea4">
                                            ...
                                            <input type="text" placeholder="Discount" name="discount_percent" id="discount_percent" value="<?php echo $radiology_data->discount_percentage; ?>" onchange="addTotal()" class="form-control discount_percent" style="width: 70%; float: right;font-size: 12px;"/></td>
                                                ...
                                                <td class="text-right ipdbilltable">
                                        <input type="text" placeholder="Discount" value="<?php echo $radiology_data->discount; ?>" name="discount" id="discount" style="width: 50%; float: right" class="form-control discount"/></td>
                                            </tr>
