            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('follow_ups_of'); ?>(<?php echo $enquiry_data['name']; ?>)</h3>
                    </div><!-- /.box-header -->
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('follow_ups_list_of'); ?> (<?php echo $enquiry_data['name']; ?>)</h3>
