            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td align="center"><h3 style="margin: 10px 0 20px;"><?php echo $this->lang->line('payslip_for_the_period_of'); ?> <?php echo $this->lang->line($result["month"]); ?> <?php echo $result["year"] ?></h3></td>
                        </tr>
                    </table>
                    ...
                    <table class="totaltable table table-striped table-responsive">
                        ...
                        <tr>
                            ...
                            <td><?php echo amountFormat($result["basic"] + $result["total_allowance"]-$result["total_deduction"]); ?></td>
                        </tr>
