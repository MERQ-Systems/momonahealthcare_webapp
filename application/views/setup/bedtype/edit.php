<form id="editbedtype" class="ptt10" accept-charset="utf-8" enctype="multipart/form-data">
    ...
    <div class="box-footer row">
        <div class="pull-right">
            <button type="submit" id="editbedtypebtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
        </div>
    </div>
</form>                  
