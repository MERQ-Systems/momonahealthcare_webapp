            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"></i><?php echo $this->lang->line('live_meeting_report'); ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="download_label"><?php echo $this->lang->line("live_meeting_report"); ?></div>
                         <table class="table table-hover table-striped table-bordered allajaxlist" data-export-title="<?php echo $this->lang->line('live_meeting_report'); ?>">
                                <thead>
                                    <tr>
        ...
        var formData = new FormData(this);
          $.ajax({
            ...
            success: function (data) {
                ...
                initDatatable('allajaxlist','admin/zoom_conference/livemeetingreport',data.param,[],100);
                }
            }
        });
