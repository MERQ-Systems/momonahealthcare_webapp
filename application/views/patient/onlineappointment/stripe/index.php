                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <form  action="<?php echo site_url('patient/onlineappointment/stripe/complete'); ?>" method="POST">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td><script
                                                ...
                                                data-description="<?php echo $this->lang->line("online_appointment_fees"); ?>"
                                                data-image="<?php echo base_url('uploads/hospital_content/logo/' . $setting['mini_logo']); ?>"
                                                data-locale="auto"
                                                data-zip-code="true"
