        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">      
                        <?php if ($this->session->flashdata('patient_import_msg')) { ?> <div>  <?php echo $this->session->flashdata('patient_import_msg') ?> </div>  <?php $this->session->unset_userdata('patient_import_msg'); }   ?>
                        <br/>           
                        1. <?php echo $this->lang->line('patient_import_instruction_one'); ?><br/>
                        2. <?php echo $this->lang->line('patient_import_instruction_two'); ?><br/>
                        
                        3. <?php echo $this->lang->line('patient_import_instruction_four'); ?><br/>
                        4. <?php echo $this->lang->line('patient_import_instruction_five'); ?><br/>
                        <hr/>
                                ...
                                <tr>
                                    ...
                                    foreach ($fields as $key => $value) {
                                        ...
                                        if ($value == 'guardian_name') {
                                            ...
                                            $value = $this->lang->line("age") . " (" . $this->lang->line("day") . ")";
                                        }else if ($value == 'insurance_id') {
                                            $value = $this->lang->line("tpa_id");
                                        }else if ($value == 'insurance_validity') {
                                            $value = $this->lang->line("tpa_validity");
                                        } else {
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?php echo $this->lang->line('blood_group'); ?></label>
                                        <div>
