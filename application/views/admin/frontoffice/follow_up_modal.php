            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="follow_date" name="date" class="form-control" value="<?php echo set_value('follow_up_date', date($this->customlib->getHospitalDateFormat(), $this->customlib->dateyyyymmddTodateformat($enquiry_data['date']))); ?>" readonly="">
