...
class Cms_menuitems_model extends MY_Model
{
    ...
    public function remove($id)
    {
        ...
        $message = DELETE_RECORD_CONSTANT . " On Front Cms Menu Items id " . $id;
        $action = "Delete";
        $record_id = $id;
    ...
    public function add($data)
    {
        ...
        if (isset($data['id']) && $data['id'] != '') {
            ...
            $message = UPDATE_RECORD_CONSTANT . " For Menu Item id " . $data['id'];
            $action = "Update";
            $record_id = $data['id'];
            $this->log($message, $record_id, $action);
        //======================Code End==============================
            ...
            $message = INSERT_RECORD_CONSTANT . " On Menu Item id " . $insert_id;
            $action = "Insert";
            $record_id = $insert_id;
            $this->log($message, $record_id, $action);
            //======================Code End==============================
