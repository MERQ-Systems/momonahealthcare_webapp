            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('ipd_discharged_patient_report'); ?></h3>
                    </div>
       ...
       $('#form1').on('submit', (function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                initDatatable('allajaxlist', 'admin/patient/ipddischargedreports/',data.param,[],100);
                }
            }
        });
        }
