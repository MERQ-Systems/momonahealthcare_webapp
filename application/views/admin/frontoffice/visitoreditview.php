                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="date" class="form-control" value="<?php echo set_value('date', date($this->customlib->getHospitalDateFormat(), $this->customlib->dateyyyymmddTodateformat($visitor_data['date']))); ?>"  name="date" readonly="">
