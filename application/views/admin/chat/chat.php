                ...
                <div id="frame">
                    ...
                    <div class="chatcontent">
                        <div class="contact-profile">
                            <img src="<?php echo base_url('uploads/patient_images/no_image.png'.img_time()); ?>" alt="" />
        ...
        <form id="addUser" action="<?php echo site_url('admin/chat/adduser') ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success btn-sm"  data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></button>
                </div>
            </div>
        </form>
    </div>
...
$(document).on('input','.chat_input',function(){
    ...
    function js_yyyy_mm_dd_hh_mm_ss(now) {
        ...
        var date_format = '<?php echo $this->customlib->getHospitalDateFormat() ?>';
