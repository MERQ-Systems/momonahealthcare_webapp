    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input id="editdate" name="date" placeholder="" type="text" class="form-control"  value="<?php echo set_value('date', $this->customlib->YYYYMMDDTodateFormat($income['date'])); ?>" readonly="readonly" />
