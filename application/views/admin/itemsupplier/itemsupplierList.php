                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools addmeeting">
                            ...
                            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm itemsupplier"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_item_supplier'); ?></a> 
                            <?php } ?>    
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                                            ...
                                            <tr> 
                                                ...
                                                <td class="mailbox-date pull-right noExport">
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('supplier', 'can_delete')) { ?>
                                                        <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordByIdReload('admin/itemsupplier/delete/<?php echo $supplier['id'] ?>', '<?php echo $this->lang->line('delete_confirm') ?>')">
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"> <?php echo $this->lang->line('add_item_supplier'); ?></h4> 
            </div>
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"> <?php echo $this->lang->line('edit_item_supplier'); ?></h4> 
            </div>
            <form id="editformadd" action="<?php echo site_url('admin/itemsupplier/edit') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('address'); ?></label>
                            <textarea class="form-control" id="address1" name="address" placeholder="" rows="3"><?php echo set_value('address'); ?></textarea>
                            <span class="text-danger"><?php echo form_error('address'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('contact_person_phone'); ?></label>
